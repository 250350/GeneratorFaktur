    ...
    //    private double netPrice;
        ...
        public String showInvoice(
                @Valid @ModelAttribute("invoiceRequest") InvoiceRequest invoiceRequest,
    ...
    //        setGrossPrice(calculateGrossPrice(invoiceRequest.getNetPrice()));
            ...
            double irpfRate = invoiceRequest.getIrpf() / 100.0;
    ...
    //    double netPriceForOne = netPriceForOneObj != null ? netPriceForOneObj : 0.0;
        ...
        Double irpfRateObj = (Double) session.getAttribute("irpfRate");
        double irpfRate = irpfRateObj != null ? irpfRateObj : 0.0;
